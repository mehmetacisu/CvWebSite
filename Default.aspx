...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            <img src="images/profile.jpeg" alt="profile image" class="img-fluid navimg">
            <h1 class="top_hd mt-2"><a href="index.html">Mehmet ACISU</a></h1>
            <p class="top_hdp mt-2">Bilgisayar Programcısı</p>
        </div>
        <!-- header -->
        <header>
            <div class="nav-top">
    ...
    <div class="main">
            ...
            <div class="container">
                <div class="mx-auto text-center">
                    ...
                    <p class="banp mx-auto mt-3">
                        <asp:Repeater runat="server" ID="RepeaterBilgiler">
                            <ItemTemplate>
                                <%# Eval("Bilgiler") %>
                            </ItemTemplate>
                        </asp:Repeater>
        ...
        <section class="slide-wrapper" id="about">
            ...
            <p class="iner mt-md-5">
                <asp:Repeater runat="server" ID="RepeaterEgitim">
                    <ItemTemplate>
                        <%# Eval("Egitim") %>
                    </ItemTemplate>
                </asp:Repeater>
        ...
        <section class="services" id="services">
            <div class="container">
                ...
                <ul class="list-unstyled mt-5">
                    <li>
                        <asp:Repeater runat="server" ID="RepeaterYetenek">
                            <ItemTemplate>
                                <div class="row">
        ...
        <div class="news" id="news">
            ...
            <p class="iner mt-md-5 text-left">
                <asp:Repeater runat="server" ID="RepeaterDeneyimlerim">
                    <ItemTemplate>
                        <%# Eval("IsDeneyimleri") %>
                    </ItemTemplate>
                </asp:Repeater>
            ...
            <div class="contact_grid_right mt-5 mx-auto text-left">
                <form action="#" method="post" runat="server">
                    <div class="row contact_top">
                        <div class="col-sm-6">
                            <asp:TextBox ID="TextBoxAd" runat="server" placeholder="Adınız" required=""></asp:TextBox>
                        </div>
                        <div class="col-sm-6">
                            <asp:TextBox ID="TextBoxMail" runat="server" placeholder="Mail Adresiniz" required=""></asp:TextBox>
                        </div>
                    </div>
                    <asp:TextBox ID="TextBoxKonu" runat="server" placeholder="Konu" required=""></asp:TextBox>
                    <asp:TextBox ID="TextBoxMesaj" runat="server" TextMode="MultiLine" Height="50" placeholder="Mesajınız" required=""></asp:TextBox>
                    <asp:Button ID="ButtonGonder" runat="server" Text="Gönder" CssClass="btn btn-info" OnClick="ButtonGonder_Click" />
                    <asp:Button ID="ButtonVazgec" runat="server" Text="Vazgeç" CssClass="btn btn-warning" />
